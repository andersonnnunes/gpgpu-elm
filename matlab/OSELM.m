function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = OSELM(TrainingData_File, TestingData_File, nHiddenNeurons, ActivationFunction, N0, Block)

% Usage: OSELM(TrainingData_File, TestingData_File, NumberofHiddenNeurons, ActivationFunction, N0, Block)
% OR:    [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = OSELM(TrainingData_File, TestingData_File, NumberofHiddenNeurons, ActivationFunction, N0, Block)
%
% Input:
...
%                           correct classification rate for classifcation
...
%
% Sample: OSELM('segment_train', 'segment_test', 1, 180, 'sig', 280, 20);
...
% Modified by Anderson Nascimento Nunes
